...
export default function Button({ id = "button", variant = "primary", size = "base", label = "Link", bold = true, onClickFn, }) {
    let buttonColor = "";
    let sizeVariant = "";
    switch (variant) {
        case "primary":
    ...
    return (_jsx("button", { id: id, type: "button", className: `${buttonColor} ${sizeVariant} ${bold && "font-semibold"} text-sm rounded-xm`, onClick: onClickFn, children: label }));
}
