...
export default function LinkButton({ href = "https://blackbull.com", variant = "primary", size = "base", label = "Link", bold = true, }) {
    let buttonColor = "";
    let sizeVariant = "";
    switch (variant) {
        case "primary":
    ...
    return (_jsx(Link, { href: href, className: `${buttonColor} ${sizeVariant} ${bold && "font-semibold"} text-sm rounded-xm`, children: label }));
}
